...
new_QToolButton = {"text": "New", "type": "QToolButton", "unnamed": 1, "visible": 1, "window": o_MainWindow}
add_QToolButton = {"text": "Add", "type": "QToolButton", "unnamed": 1, "visible": 1, "window": o_MainWindow}
...
file_QToolBar = {"type": "QToolBar", "unnamed": 1, "visible": 1, "window": o_MainWindow, "windowTitle": "File"}
file_QTableWidget = {"aboveWidget": file_QToolBar, "type": "QTableWidget", "unnamed": 1, "visible": 1, "window": o_MainWindow}
file_QHeaderView = {"container": file_QTableWidget, "orientation": 2, "type": "QHeaderView", "unnamed": 1, "visible": 1}
o1_HeaderViewItem = {"container": file_QHeaderView, "text": 1, "type": "HeaderViewItem", "visible": True}
remove_QToolButton = {"text": "Remove", "type": "QToolButton", "unnamed": 1, "visible": 1, "window": o_MainWindow}
